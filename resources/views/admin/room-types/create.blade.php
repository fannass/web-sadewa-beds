<x-admin-layout>
    ...
    <div class="mb-6">
        <a href="{{ route('admin.room-types.index') }}"
            class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-green-600 mb-4">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Tambah Tipe Kamar</h1>
        <p class="text-sm text-gray-500 mt-1">Buat tipe kamar baru</p>
    </div>
    ...
    <div class="card p-5 sm:p-6 max-w-2xl">
        <form action="{{ route('admin.room-types.store') }}" method="POST">
            ...
            <div class="space-y-5">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Nama Tipe <span
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        ...
                        placeholder="Deskripsi singkat tentang tipe kamar">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="flex items-center gap-3 mt-8 pt-6 border-t border-gray-100">
                ...
                <a href="{{ route('admin.room-types.index') }}"
                    class="px-6 py-3 text-sm font-medium text-gray-600 hover:text-gray-800">
                    Batal
                </a>
            </div>
        </form>
